...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .headline-highlight{color:var(--restore);}
  ...
  .cs-btn:active{transform:translateY(-1px);transition-duration:.1s;}
  .cs-btn--primary{background:var(--restore);color:#fff;box-shadow:0 0 0 rgba(31,138,112,0);}
  .cs-btn--primary:hover{background:#186E5A;box-shadow:0 14px 28px -12px rgba(31,138,112,.55);}
  .cs-btn--ghost{border:1px solid var(--line);color:var(--ink);}
  .cs-btn--ghost:hover{border-color:var(--restore);color:var(--restore);box-shadow:0 12px 24px -14px rgba(31,138,112,.35);}
  .cs-btn--ghost-dark{border:1px solid #3A4550;color:#fff;}
  .cs-btn--ghost-dark:hover{border-color:var(--restore);color:#7FE0BE;background:rgba(31,138,112,.1);box-shadow:0 12px 24px -14px rgba(31,138,112,.4);}
  @media (prefers-reduced-motion: reduce){ .cs-btn{transition:none;} .cs-btn:hover,.cs-btn:active{transform:none;} }
  ...
  .cs-hero h1{font-size:clamp(30px,4.4vw,46px);font-weight:300;line-height:1.12;margin-bottom:18px;color:#fff;}
  .cs-hero p{color:#C3CDD5;font-size:18.5px;max-width:520px;margin-bottom:26px;}
  ...
  .cs-issue-list__head{
    font-family:'IBM Plex Mono',monospace;font-size:16px;font-weight:600;letter-spacing:.06em;
    padding:12px 20px;border-bottom:1px solid var(--line);background: #FFE2D8;
  }
  ...
  .cs-issue-list .txt{font-size:16px;color:var(--ink);}
  ...
  .cs-features__card h3{font-size:18px;font-weight:600;margin-bottom:8px;}
  .cs-features__card p{font-size:16px;color:var(--ink-soft);margin:0;}
  ...
  .cs-download p{color:var(--ink-soft);font-size:16px;margin:10px 0 0;}
  .cs-download__form{display:grid;gap:10px;}
  .cs-download__form input{font-family:'Inter',sans-serif;font-size:14px;padding:12px 14px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--ink);}
  .cs-download__form input::placeholder{color:var(--ink-faint);}
  /* Input focus state */
.cs-consult__form input:focus,
.cs-consult__form textarea:focus {
    outline: none;
    border-color: #FF6C3A;
    box-shadow: 0 0 0 2px rgba(255, 108, 58, 0.15);
}
  ...
  .cs-related-carousel__arrow{
    ...
    transition:border-color .2s ease,color .2s ease,transform .2s cubic-bezier(.4,0,.2,1),box-shadow .2s ease;
    flex:0 0 auto;
  }
  .cs-related-carousel__arrow:hover{
    border-color:var(--restore);color:var(--restore);transform:translateY(-2px) scale(1.08);
    box-shadow:0 10px 20px -10px rgba(31,138,112,.4);
  }
  .cs-related-carousel__arrow:active{transform:translateY(0) scale(.96);}
  ...
  .cs-related-carousel__dot:hover{background:var(--ink-faint);transform:scale(1.25);}
  .cs-related-carousel__dot.active{background:var(--restore);transform:scale(1.35);}
  .cs-related-carousel__dot.active:hover{background:#186E5A;transform:scale(1.45);}
  @media (prefers-reduced-motion: reduce){
    .cs-related-carousel__arrow,.cs-related-carousel__dot{transition:background-color .2s ease,border-color .2s ease,color .2s ease;}
    .cs-related-carousel__arrow:hover,.cs-related-carousel__arrow:active,
    .cs-related-carousel__dot:hover,.cs-related-carousel__dot.active{transform:none;}
  }
  ...
  .cs-consult__form input,.cs-consult__form textarea{font-family:'Inter',sans-serif;font-size:14px;padding:12px 14px;border:1px solid var(--line);border-radius:8px;background:var(--panel);color:var(--ink);width:100%;}
...
<header class="cs-hero" id="hero">
  <div class="cs-hero__bg" aria-hidden="true">
    <img src="images/26040.jpg" alt="background image of a cloud-based data and backup operations platform" />
  </div>
  ...
  <div class="cs-wrap cs-hero__inner">
    ...
    <div class="cs-hero__content">
      ...
      <h1>Cloud-based Data &amp; <span class="headline-highlight">Backup Operations Platform</span></h1>
  ...
  <div class="cs-wrap">
    <div class="cs-download">
      ...
      <form class="cs-consult__form" onsubmit="return false;">
        ...
        <button type="submit" class="cs-btn cs-btn--primary">Download Case Study</button>
      </form>
    </div>
  </div>
</section>
...
<section class="cs-section reveal" id="consult">
  <div class="cs-wrap">
    ...
    <div class="cs-consult">
      <form class="cs-consult__form" onsubmit="return false;">
        <p style="color:var(--ink-soft);font-size:16px;margin:0 0 6px;">Get a 30-minute free consultation from a field expert. Validate your idea for free and get a rough quote once you complete this form.</p>
        <input type="text" placeholder="Your Name *" required>
      ...
      <div class="cs-consult__card">
        ...
        <a class="cs-btn cs-btn--primary" href="https://www.softsuave.com/30-min-free-consultation">Schedule a Call</a>
